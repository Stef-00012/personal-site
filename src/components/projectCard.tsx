                    ...
                    {project.git ? (
                        <div className="top-repo-info font-mono">
                            <p className="me-2 text-warning">
                                <Link href={`https://github.com/${project.git.fullName}/stargazers`}>
                            ...
                            <p className="me-2 text-error">
                                <Link href={`https://github.com/${project.git.fullName}/issues`}>
                                    <span className="me-1 icon-[tabler--circle-dot] -mb-1 size-5" />
                                    {project.git.openIssues}
                                </Link>
                            </p>
                            <p className="me-2 text-accent">
                                <Link href={`https://github.com/${project.git.fullName}/watchers`}>
                            ...
                            {project.git.license && (
                                <>
                                    ...
                                    {project.git.license.url ? (
                                        <Link href={project.git.license.url as string} className="-mt-2 text-base-content/70 italic">
