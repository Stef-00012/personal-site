...
export const projects: Array<Project> = [
	{
        ...
        description: "Receiptify is a website that allows you to convert your top tracks (on last.fm or Spotify). It fetches your top tracks and renders them in a way to look like a receipt.",
	...
	},
	{
        ...
        description: "Zipline Uploads allow you to upload your right clicked files or shorten your right clicked URLs to your selfhosted instance of Zipline without having to download the file to your PC and upload it manually.",
	...
	},
	{
        ...
        description: "userApps is a multi-purpose Discord bot iinstalled on your user account so that it can be used everywhere.",
	...
	},
	{
        ...
        description: "An API is used to communicate with my apps or to get data about them (Not really mainatined anymore)."
    },
	{
